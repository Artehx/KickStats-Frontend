       ...
       <div className="w-full h-full ">
         ...
         */ }
         ...
         <div className="flex justify-center bg-black">
           <img src="/images/kickStatsLogo.png" alt="logo" class='w-36 mx-auto' />

         </div>

         <div class="font-[sans-serif] bg-white text-[#333] md:h-screen">
            <div class="grid md:grid-cols-2 items-center gap-8 h-full">
              <div class="max-md:order-1 pt-3.5 pl-3.5 bg-gray-50 h-5/6">
              ...
              <div class="flex items-center p-6 h-full w-full">
                <form class="max-w-lg w-full mx-auto">
                  ...
                  <div>
                    <label class="text-xs block mb-2">Nombre completo</label>
                  ...
                  <div class="mt-12">
                    <button type="button" class="w-full py-2.5 px-8 text-sm font-semibold rounded bg-blue-500 hover:bg-blue-600 text-white border focus:outline-none">
                      Creat an account
                    </button>
                    <p class="text-sm mt-8">Already have an account? <a href="javascript:void(0);" class="text-blue-500 font-semibold hover:underline ml-1">Login here</a></p>
                  </div>
                </form>
              </div>
            </div>
